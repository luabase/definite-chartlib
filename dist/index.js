...
// src/determine/helpers.ts
function findStateAndNumberIndices(dataArray) {
  let stateIndex = -1;
  let numberIndex = -1;
...
function isState(value) {
  return value in stateAbbreviations || Object.values(stateAbbreviations).includes(value);
}
function isNumber(value) {
  return !isNaN(parseFloat(value)) && isFinite(value);
}
function findMinMax(datasetsSource) {
  ...
  datasets2.slice(1).forEach((dataset) => {
    ...
    if (chart.getStyleOrientation() === "horizontal") {
      ...
      dataset.source.forEach((sourceItem) => {
        data.push({
          name: sourceItem[stateIndex].length == 2 ? stateAbbreviations[sourceItem[stateIndex]] : sourceItem[stateIndex],
...
export {
  ...
  mockData_default as mockData,
  stateAbbreviations,
  usaMap_default as usaMap
};
