...
type Dimension<T extends ChartType> = Identifiable &
  Indexable &
...
type ChartSpecificMetric<T extends ChartType> = T extends "bar"
  ...
  : {};
type Metric<T extends ChartType> = Identifiable &
  Indexable &
...
type ExtraStyleOptions<T extends ChartType> = T extends "bar"
  ...
  : {};
type StyleOptions<T extends ChartType> = BaseStyleOptions &
  ExtraStyleOptions<T>;
...
declare class Chart<T extends ChartType> {
  ...
  static fromLegacy<T extends ChartType>(
...
declare function load<T extends ChartType>(
  opts: ChartOptions<T> | LegacyOptions<T>
):
  | Chart<"bar">
  | Chart<"line">
  | Chart<"pie">
  ...
  | Chart<"calendar">
  | Chart<T>;
declare function chartGenerator(
  columns: Array<ColumnOptions>,
  subsets: boolean
): Generator<Chart<ChartType>, void, unknown>;
